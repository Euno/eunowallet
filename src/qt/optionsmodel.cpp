...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeeunoAmount"))
        settings.setValue("nAnonymizeeunoAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeeunoAmount = settings.value("nAnonymizeeunoAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeeunoAmount"))
        SoftSetArg("-anonymizeeunoamount", settings.value("nAnonymizeeunoAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeeunoAmount:
            nAnonymizeeunoAmount = value.toInt();
            settings.setValue("nAnonymizeeunoAmount", nAnonymizeeunoAmount);
            emit anonymizeeunoAmountChanged(nAnonymizeeunoAmount);
            break;
        default:
            break;
        }
