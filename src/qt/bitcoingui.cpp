...
{
    resize(1080, 662);
    setWindowTitle(tr("Euno") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("euno");
    setStyleSheet("#euno { background-color: #f9f9f9);  }"
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Euno address"));
    ...
    masternodeManagerAction->setToolTip(tr("Show Euno Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About Euno"), this);
    aboutAction->setToolTip(tr("Show information about Euno"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Euno"));
...
void BitcoinGUI::createToolBars()
{
   ...
   //  toolbar->setStyleSheet("#tabs { background-color: #f9f9f9; } ");
    toolbar->setStyleSheet("QToolButton { color: #5677d8; } QToolButton:pressed { background-color: none } #tabs { color: #af0e0e; background-color: #f9f9f9);  }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Euno client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Euno client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Euno network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Euno address or malformed URI parameters."));
    }
