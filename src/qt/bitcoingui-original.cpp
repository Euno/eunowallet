...
void BitcoinGUI::createActions()
{
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/bitcoin"), tr("&eunoNodes"), this);
    masternodeManagerAction->setToolTip(tr("Show eunoNodes Nodes status and configure your nodes."));
