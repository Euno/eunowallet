...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,           (numeric) the total euno balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zEUNOsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zEUNO denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zEUNO denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zEUNO denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zEUNO denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zEUNO denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zEUNO denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zEUNO denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zEUNO denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zEUNO denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,      (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,          (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,        (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,           (numeric) the transaction fee set in euno/kb\n"
            "  \"relayfee\": x.xxxx,           (numeric) minimum relay fee for non-free transactions in euno/kb\n"
    ...
    obj.push_back(Pair("zEUNOsupply", zpivObj));
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            "validateaddress \"eunoaddress\"\n"
            "\nReturn information about the given euno address.\n"

            "\nArguments:\n"
            "1. \"eunoaddress\"     (string, required) The euno address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"eunoaddress\",    (string) The euno address validated\n"
            "  \"scriptPubKey\" : \"hex\",       (string) The hex encoded scriptPubKey generated by the address\n"
            "  \"ismine\" : true|false,          (boolean) If the address is yours or not\n"
            "  \"isstaking\" : true|false,       (boolean) If the address is a staking address for EUNO cold staking\n"
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are euno addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) euno address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            "verifymessage \"eunoaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"eunoaddress\"  (string, required) The euno address to use for the signature.\n"
...
UniValue getstakingstatus(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"staking_enabled\": true|false,     (boolean) whether staking is enabled/disabled in euno.conf\n"
            "  \"coldstaking_enabled\": true|false, (boolean) whether cold-staking is enabled/disabled in euno.conf\n"
            "  \"haveconnections\": true|false,     (boolean) whether network connections are present\n"
            "  \"mnsync\": true|false,              (boolean) whether the required masternode/spork data is synced\n"
            "  \"walletunlocked\": true|false,      (boolean) whether the wallet is unlocked\n"
            "  \"stakeablecoins\": n                (numeric) number of stakeable UTXOs\n"
            "  \"stakingbalance\": d                (numeric) EUNO value of the stakeable coins (minus reserve balance, if any)\n"
