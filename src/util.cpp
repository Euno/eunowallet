...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\euno
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\euno
    // Mac: ~/Library/Application Support/euno
    // Unix: ~/.euno
#ifdef WIN32
    // Windows
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "euno.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "eunod.pid"));
