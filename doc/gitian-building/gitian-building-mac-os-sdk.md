...
The script [extract-osx-sdk.sh](https://git.blaize.tech/EUNO/euno-node.git/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
Troubleshooting
---------------
See [README_osx.md](https://git.blaize.tech/EUNO/euno-node.git/blob/master/doc/README_osx.md) for troubleshooting tips.