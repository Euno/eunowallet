PIVX Core version *3.3.0* is now available from:  <https://git.blaize.tech/EUNO/euno-node.git/releases>
...
Several new commands were added in v2.3.1 to replace the two aforementioned commands, reference the [v2.3.1 Release Notes](https://git.blaize.tech/EUNO/euno-node.git/blob/master/doc/release-notes/release-notes-2.3.1.md#rpc-changes) for further details.
