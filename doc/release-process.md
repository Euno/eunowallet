...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://git.blaize.tech/EUNO/euno-node.git/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://git.blaize.tech/EUNO/euno-node.git/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://git.blaize.tech/EUNO/euno-node.git-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://git.blaize.tech/EUNO/euno-node.git.git
...
- Detached signatures will then be committed to the [pivx-detached-sigs](https://git.blaize.tech/EUNO/euno-node.git-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://git.blaize.tech/EUNO/euno-node.git/releases/new) with a link to the archived release notes.
